...
def returns_from_equity(equity: SeriesLike)->SeriesLike:
...
def sharpe_ratio(ret: SeriesLike, periods_per_year: int = 365)->float:
...
def turnover_from_position(position_qty:SeriesLike)->float: 
